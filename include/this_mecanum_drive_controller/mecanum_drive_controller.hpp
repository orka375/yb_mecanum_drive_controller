...
#include "this_mecanum_drive_controller/this_mecanum_drive_controller_parameters.hpp"
#include "this_mecanum_drive_controller/odometry.hpp"
...
class This_MecanumDriveController : public controller_interface::ChainableControllerInterface
{
public:
  This_MecanumDriveController();
...
protected:
  std::shared_ptr<this_mecanum_drive_controller::ParamListener> param_listener_;
  this_mecanum_drive_controller::Params params_;
