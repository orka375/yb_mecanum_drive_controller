...
#include "this_mecanum_drive_controller/mecanum_drive_controller.hpp"
...
using ControllerReferenceMsg = this_mecanum_drive_controller::This_MecanumDriveController::ControllerReferenceMsg;
...
namespace this_mecanum_drive_controller
{
  This_MecanumDriveController::This_MecanumDriveController()
: controller_interface::ChainableControllerInterface()
{
}

controller_interface::CallbackReturn This_MecanumDriveController::on_init()
{
  try
  {
    param_listener_ = std::make_shared<this_mecanum_drive_controller::ParamListener>(get_node());
  }
...
controller_interface::CallbackReturn This_MecanumDriveController::on_configure(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  ...
  ref_subscriber_ = get_node()->create_subscription<ControllerReferenceMsg>(
    ...
    std::bind(&This_MecanumDriveController::reference_callback, this, std::placeholders::_1));
  ...
  RCLCPP_INFO(get_node()->get_logger(), "This_MecanumDriveController configured successfully");

  return controller_interface::CallbackReturn::SUCCESS;
}

void This_MecanumDriveController::reference_callback(const std::shared_ptr<ControllerReferenceMsg> msg)
{
...
This_MecanumDriveController::command_interface_configuration() const
{
...
controller_interface::InterfaceConfiguration This_MecanumDriveController::state_interface_configuration()
  const
{
...
This_MecanumDriveController::on_export_reference_interfaces()
{
...
bool This_MecanumDriveController::on_set_chained_mode(bool chained_mode)
{
  // Always accept switch to/from chained mode
  return true || chained_mode;
}

controller_interface::CallbackReturn This_MecanumDriveController::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::CallbackReturn This_MecanumDriveController::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
controller_interface::return_type This_MecanumDriveController::update_reference_from_subscribers(
...
controller_interface::return_type This_MecanumDriveController::update_and_write_commands(
  const rclcpp::Time & time, const rclcpp::Duration & period)
{
...
PLUGINLIB_EXPORT_CLASS(
  this_mecanum_drive_controller::This_MecanumDriveController,
  controller_interface::ChainableControllerInterface)
