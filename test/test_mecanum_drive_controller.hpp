...
using ControllerStateMsg = this_mecanum_drive_controller::This_MecanumDriveController::ControllerStateMsg;
using ControllerReferenceMsg =this_mecanum_drive_controller::This_MecanumDriveController::ControllerReferenceMsg;
using TfStateMsg = this_mecanum_drive_controller::This_MecanumDriveController::TfStateMsg;
using OdomStateMsg = this_mecanum_drive_controller::This_MecanumDriveController::OdomStateMsg;
...
class TestableMecanumDriveController : public this_mecanum_drive_controller::This_MecanumDriveController
{
...
public:
  ...
  {
    return this_mecanum_drive_controller::This_MecanumDriveController::on_configure(previous_state);
  }
    ...
    const rclcpp_lifecycle::State & previous_state) override
  {
    ...
    return this_mecanum_drive_controller::This_MecanumDriveController::on_activate(previous_state);
  }
